...
namespace CPU.InstructionDecode.Instructions.Arithmetic
{
    ...
    {
        public RorInstruction(byte opCode, AddressingMode addressingMode, Mos6502Core core) : base("ROR", opCode, addressingMode, core)
        {
        ...
        private byte DoRol(byte number)
        {
            ...
            result |= (byte)((byte)(Core.Registers.Flags & StatusFlags.Carry) << 7);
