...
namespace M6502.InstructionDecode.Instructions.Arithmetic
{
    ...
    {
        public OraInstruction(byte opCode, AddressingMode addressingMode, M6502Core core) : base("ORA", opCode, addressingMode, core)
        {
        ...
        {
            // 1 cycle
            LoadAndDoOr(Core.Registers.ProgramCounter);
        ...
        /// Cycles: 1.
        /// </summary>
        private void LoadAndDoOr(ushort address)
        {
            // 1 cycle
